...
Thank you for sending us your workshop proposal!
...
{{ proposal.type|verbose_name }}
{{ proposal.type }} {% comment %} display 'Workshop' or 'Sprint'{% endcomment %}

{{ proposal.length|verbose_name }}
{{ proposal.length }} {% comment %} display '1 hour' or '2 hours' …{% endcomment %}
...
{% if proposal.needs_finaid %}You required financial aid
{% if proposal.finaid_details %}with the following details:{% else %}without providing details.{% endif %}
{{ proposal.finaid_details }}
{% endif %}
{{ proposal.requirements|verbose_name }}
{{ proposal.requirements|default:"not provided" }}
